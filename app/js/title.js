...
(function(o){if(window.attachEvent){window.attachEvent("onload",o);}else{window.addEventListener("load",o,false);};})(function(){
    var d=document,
        ...
        l=function(u,y){
            ...
            if(y=="script"){s.src=u;s.type="text/javascript";s.setAttribute("charset","utf-8");}
    ...
    m.innerHTML=['<ul class="ost_b">',
        ...
        '<li class="ost_i">',
        '<p class="ost_t ost_bg"><a href="http://lol.qq.com/main.shtml" target="_blank" class="ost_lnk" onclick="pgvSendClick({hottag:\'act.title.back\'});">返回官网首页</a></p>',
        '<p class="ost_gl">',
        '<a href="http://lol.qq.com/download.shtml" target="_blank" class="ost_lnk ost_ldc" onclick="pgvSendClick({hottag:\'act.title.down\'});">游戏下载</a>',
        '<a href="http://lol.qq.com/comm-htdocs/pay/new_index.htm?t=lol" target="_blank" class="ost_lnk ost_ldc" onclick="pgvSendClick({hottag:\'act.title.pay\'});"> 点券充值</a>',
        '</p>',
        '</li>',
        '</ul>'].join("");
